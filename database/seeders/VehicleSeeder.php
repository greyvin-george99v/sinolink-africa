...
class VehicleSeeder extends Seeder
{
    public function run()
    {
        ...
        \App\Models\Vehicle::create([
            'name'    => $data['name'],
            // 2. ADD A RANDOM NUMBER TO SLUG TO ENSURE UNIQUENESS
            'slug'    => \Illuminate\Support\Str::slug($data['name']) . '-' . rand(1000, 9999),
            'price'   => $data['price'],
            'year'    => $data['year'],
            'km'      => $data['km'],
            'fuel'    => $data['fuel'],
            'color'   => $data['color'],
            'trans'   => $data['trans'],
            // 3. KEEP THE IMAGE FALLBACK WE ADDED
            'image'   => $data['image'] ?? 'pending.jpg', 
